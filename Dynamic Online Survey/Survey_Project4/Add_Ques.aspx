    ...
    <form id="form1" runat="server">
        ...
        <div class="main">
            ...
            <h1 class="h"> Survey question by admin </h1>
                <asp:Button ID="about" runat="server" Text="Result" CssClass="about" OnClick="about_Click" />
                <asp:Button ID="home" runat="server" Text="Exit" CssClass="about" OnClick="home_Click" />
            ...
            <div class="two">
                ...
                <asp:TextBox ID="TextBox10" runat="server" style="width:90%;font-size:x-large;"></asp:TextBox> <br /><br /><br />
                    ...
                    <asp:Label ID="Label11" runat="server" Text="" Style="font-size:x-large; margin-left:35%;color:#10BC10; font-weight:bold;" ></asp:Label>
                    <br />
