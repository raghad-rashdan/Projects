        ...
        public async Task<ActionResult> Register(int sel, RegisterViewModel model, HttpPostedFileBase image2, HttpPostedFileBase id_img, HttpPostedFileBase certificate_img)
        {
            ...
            var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
                ...
                if (image2 != null)
                {
                    ...
                    image2.SaveAs(path);
                    customer.img = "../Content/Images/" + fileName;
                }
                else
                {
                ...
                if (id_img != null)
                {
                    if (!id_img.ContentType.ToLower().StartsWith("image/"))
                    {
                        ModelState.AddModelError("", "file uploaded is not an image");
                        return View();
                    }
                    ...
                    string fileName = Path.GetFileName(id_img.FileName);
                    string path = Path.Combine(folderPath, fileName);
                    id_img.SaveAs(path);
                    customer.ID_img = "../Content/Images/" + fileName;
                }
                else
                {
                    ModelState.AddModelError("", "Please upload an image.");
                ...
                {
                    if (!certificate_img.ContentType.ToLower().StartsWith("image/"))
                    {
                        ModelState.AddModelError("", "file uploaded is not an image");
                        return View();
                    }
                    ...
                    string fileName = Path.GetFileName(certificate_img.FileName);
                    string path = Path.Combine(folderPath, fileName);
                    certificate_img.SaveAs(path);
                    customer.certificate_img = "../Content/Images/" + fileName;
                }
                else
                {
                    ModelState.AddModelError("", "Please upload an image.");
